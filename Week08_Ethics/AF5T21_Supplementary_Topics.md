...
#### (2) Decentralization vs Accountability（去中心化 vs 問責）
- 去中心化是否意味著「無人負責」？
- DAO 嘅治理失效問題
- 一幣一票 vs 一人一票
- **案例：** The DAO 2016 被 hack、Compound 治理攻擊
- **解決方法：** 形式化治理 + 委託投票 + 時間鎖

#### (3) Environmental Impact（環境影響）
- PoW（工作量證明）能耗爭議 — Bitcoin 每年用電約 200 TWh
- PoS（權益證明）較環保 — Ethereum 2.0 減 99.95% 能耗
- **數據：** 1 Bitcoin 交易 ≈ 1 家庭 1 個月用電
- **解決方法：** 轉向 PoS + 使用再生能源 + 碳信用

#### (4) Financial Inclusion vs Speculation（金融普惠 vs 投機）
- Web3 係普惠金融（跨境支付、無銀行帳戶）？
- 定係新形式嘅賭博（高槓桿、波動）？
- **正方：** DeFi 服務 14 億無銀行戶口人口
- **反方：** 散戶虧損率高（Diem 研究：50% 散戶虧損）
- **解決方法：** 投資者教育 + 適當性評估 + 產品設計

#### (5) 香港視角
- **SFC VASP 牌照**（2023 生效）— 平衡創新 + 投資者保護
- **穩定幣條例**（2025 生效）— 防洗錢 + 金融穩定
- **現貨 ETF**（2024 批准）— 機構資金入場
- **沙盒機制**（Fintech 試點）
- **零售投資者保護**（適當性評估 + 風險聲明）

### 3.5 Web3 倫理決策矩陣

| 議題 | 支持立場（創新）| 反對立場（保護）| 平衡立場 |
|------|----------------|----------------|----------|
| 投資者保護 | 自我責任 | 強制 KYC | 適當性評估 |
| 環境影響 | PoW 創新 | 禁 PoW | 鼓勵 PoS |
| DAO 治理 | 完全去中心化 | 中心化監督 | 混合治理 |
| DeFi | 金融普惠 | 投機賭場 | 監管沙盒 |
| 匿名性 | 私隱權 | 反洗錢 | 選擇性 KYC |
